...
#ifdef DEBUG_CONTROL_STAT
      Serial.print(
          "Control Debug : Check RotaryEncoder, impossible stat 0 to 3 !");
#endif
      return false;
    }
...
#ifdef DEBUG_CONTROL_STAT
      Serial.print(
          "Control Debug : Check RotaryEncoder, impossible stat 1 to 2 !");
#endif
      return false;
    }
...
#ifdef DEBUG_CONTROL_STAT
      Serial.print(
          "Control Debug : Check RotaryEncoder, impossible stat 2 to 1 !");
#endif
      return false;
    }
...
#ifdef DEBUG_CONTROL_STAT
      Serial.print(
          "Control Debug : Check RotaryEncoder, impossible stat 3 to 0 !");
#endif
      return false;
    }
  }
