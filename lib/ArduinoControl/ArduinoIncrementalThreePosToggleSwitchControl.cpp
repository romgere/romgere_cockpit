...
ArduinoIncrementalThreePosToggleSwitchControl::
  ...
  this->LastPinStatus[INCREMENTAL_TOGGLESWITCH_CUR_STATUS_INDEX] =
      this->LastPinStatus[INCREMENTAL_TOGGLESWITCH_OLD_STATUS_INDEX] = 0;

  bitWrite(this->LastPinStatus[INCREMENTAL_TOGGLESWITCH_CUR_STATUS_INDEX], 0,
           _digitalRead(this->Pin1) == HIGH);
  bitWrite(this->LastPinStatus[INCREMENTAL_TOGGLESWITCH_CUR_STATUS_INDEX], 1,
           _digitalRead(this->Pin2) == HIGH);

  this->LastPinStatus[INCREMENTAL_TOGGLESWITCH_OLD_STATUS_INDEX] =
      this->LastPinStatus[INCREMENTAL_TOGGLESWITCH_CUR_STATUS_INDEX];
}
...
bool ArduinoIncrementalThreePosToggleSwitchControl::ReadInput() {
  ...
  // Status changed ?
  return this->LastPinStatus[INCREMENTAL_TOGGLESWITCH_OLD_STATUS_INDEX] !=
         this->LastPinStatus[INCREMENTAL_TOGGLESWITCH_CUR_STATUS_INDEX];
}

// On retourne une valeur de type float en fonction de l'état du toggle switch
// et du mode demandé
float ArduinoIncrementalThreePosToggleSwitchControl::getValue() {
  ...
  // First position
  else if (this->LastPinStatus[INCREMENTAL_TOGGLESWITCH_CUR_STATUS_INDEX] ==
           2) {
    return 0;
  }
