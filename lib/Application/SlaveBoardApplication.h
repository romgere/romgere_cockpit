...
private:
  ...
  MasterToSlaveCommand
      *lastPinForValueSend; // Last "GetPINValue" command informations

  // Queue of received command from master. Allows keep commands received from
  // I2C without doing any write/read operations to free the I2C bus quickly.
